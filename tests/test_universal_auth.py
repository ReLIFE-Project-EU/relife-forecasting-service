...
# @pytest.mark.asyncio
# @patch("relife_forecasting.auth.dependencies._authenticate_with_supabase")
...
# @pytest.mark.asyncio
# @patch("relife_forecasting.auth.dependencies._authenticate_with_keycloak")
# @patch("relife_forecasting.auth.dependencies._authenticate_with_supabase")
...
# @pytest.mark.asyncio
# @patch("relife_forecasting.auth.dependencies._fetch_keycloak_roles")
# @patch("relife_forecasting.auth.dependencies._authenticate_with_supabase")
